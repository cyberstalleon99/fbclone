            ...
            <div className="carousel-item active">
                <div className="carousel-container">
                    ...
                    <p className="animate__animated animate__fadeInUp" style={{color:'#888245'}} >
                        <span>Watch ____ videos for free, here on ____.com. Discover the growing collection of high quality Most Relevant YYY movies and clips.</span> 
                        </p>
